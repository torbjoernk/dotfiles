...
" need to source these to make the statusline functions properly working
source ~/.vim/bundle/vim-fugitive/plugin/fugitive.vim
source ~/.vim/bundle/vim-rvm/plugin/rvm.vim
silent! call fugitive#statusline()
silent! call rvm#statusline()
...
au InsertEnter * hi StatusLine ctermbg=LightRed
